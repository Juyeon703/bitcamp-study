...
public class MybatisConfig {
  ...
  @Bean
  public SqlSessionFactory sqlSessionFactory(DataSource ds, ApplicationContext iocContainer) throws Exception {
    System.out.println("MybatisConfig() 호출됨!");

    // Mybatis의 log4j기능 활성화 시키기
    ...
    factoryBean.setMapperLocations(iocContainer.getResources("classpath:com/bitcamp/board/mapper/*Mapper.xml"));
