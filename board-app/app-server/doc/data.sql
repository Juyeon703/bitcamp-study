-- 회원 데이터 입력
insert into app_member(mno,name,email,pwd) values(1,'admin','admin@test.com',sha2('1111',256));
insert into app_member(mno,name,email,pwd) values(2,'user1','user1@test.com',sha2('1111',256));
insert into app_member(mno,name,email,pwd) values(3,'user2','user2@test.com',sha2('1111',256));
insert into app_member(mno,name,email,pwd) values(4,'user3','user3@test.com',sha2('1111',256));
insert into app_member(mno,name,email,pwd) values(5,'user4','user4@test.com',sha2('1111',256));
insert into app_member(mno,name,email,pwd) values(6,'user5','user5@test.com',sha2('1111',256));
