...
public class DataSource {
  ...
  public DataSource(String driver, String jdbcUri, String username, String password) throws Exception {
  ...
  public Connection getConnection() throws Exception {
    ...
    if (con == null) { // 현재 스레드 보관소에 커넥션 객체가 없다면,
      con = DriverManager.getConnection(jdbcUri, username, password); // 새로 생성
